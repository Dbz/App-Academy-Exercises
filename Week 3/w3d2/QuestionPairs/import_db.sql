...
-- (SELECT user_id FROM users WHERE fname = 'CJ') c_id;
-- (SELECT user_id FROM users WHERE fname = 'Gilly') g_id;
...
-- (SELECT question_id FROM questions WHERE question_id = 1) q_1_id;
-- (SELECT question_id FROM questions WHERE question_id = 2) q_2_id;
...
-- (SELECT reply_id FROM replies WHERE reply_id = 1) q_1_repl_id;
