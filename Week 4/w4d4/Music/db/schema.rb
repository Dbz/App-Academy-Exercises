...
ActiveRecord::Schema.define(version: 20141031003601) do
  ...
  add_index "albums", ["name", "band_id"], name: "index_albums_on_name_and_band_id"
  ...
  add_index "tracks", ["name", "album_id"], name: "index_tracks_on_name_and_album_id"
